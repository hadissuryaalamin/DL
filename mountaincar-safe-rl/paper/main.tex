...
Table~\ref{tab:stage2} lists all 18 constrained configurations (S1--S18) and
Figure~\ref{fig:stage2} plots them in the cost--return plane.
...
\begin{table}[t]
  \centering
  \caption{Stage 2 (Safe~PPO) sweep. Final-window (last 10 epochs) mean$\pm$std over 3 seeds, with
...
\begin{table}[t]
  \centering
  \caption{Final-window performance. Mean$\pm$std across 3 seeds (\texttt{--seeds 0 1 2}). Final
  return is averaged over the last 50 episodes (DQN) or last 10 epochs (PPO, Safe~PPO). PPO is the
